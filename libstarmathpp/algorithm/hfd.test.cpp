...
//    filenameSs << "test_data/algorithm/hfd/gaussian_normal_distribution_2d/gaussian_2d_sigma"
...
//                                     Point<unsigned int>(120,120), // star center position completely out of range of the image dimensions, lower right corner
//                                     Point<unsigned int>(130,50),  // x coordinate out of bounds
//                                     Point<unsigned int>(0,0),     // star center position inside image dimensions but "outer diameter" outside image boundaries, top left corner
//                                     Point<unsigned int>(119,119), // lower right corner
//                                     Point<unsigned int>(60,60)
//                             }) ^
//                     bdata::make(
//                             std::vector< int > {
//                                     3, 3, 3, 3,
