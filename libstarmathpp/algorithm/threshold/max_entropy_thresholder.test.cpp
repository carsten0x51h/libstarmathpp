...
#define BOOST_TEST_MODULE "algorithm max etropy thresholder unit test"
...
BOOST_AUTO_TEST_SUITE (algorithm_max_entropy_thresholder_tests)
 ...
 *
 */
BOOST_AUTO_TEST_CASE(algorithm_max_entropy_thresholder_test) {
